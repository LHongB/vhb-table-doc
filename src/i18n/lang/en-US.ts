  ...
  app: {
    aside: {
      nav: {
        ...
        api: 'API',
        vxeTable: 'vhb-table',
        vxeTableColgroup: 'vhb-colgroup',
        vxeTableColumn: 'vhb-column',
        vxeGrid: 'vhb-grid',
        vxeVirtualTree: 'vhb-virtual-tree',
        vxeExcel: 'vhb-excel',
        vxeToolbar: 'vhb-toolbar',
        vxePager: 'vhb-pager',
        vxeRadio: 'vhb-radio',
        vxeRadioGroup: 'vhb-radio-group',
        vxeRadioButton: 'vhb-radio-button',
        vxeCheckbox: 'vhb-checkbox',
        vxeCheckboxGroup: 'vhb-checkbox-group',
        vxeInput: 'vhb-input',
        vxeTextarea: 'vhb-textarea',
        vxeSelect: 'vhb-select',
        vxeOptgroup: 'vhb-optgroup',
        vxeOption: 'vhb-option',
        vxeButton: 'vhb-button',
        vxeTooltip: 'vhb-tooltip',
        vxeModal: 'vhb-modal',
        vxeForm: 'vhb-form',
        vxeFormItem: 'vhb-form-item',
        vxeFormGather: 'vhb-form-gather',
        vxeSwitch: 'vhb-switch',
        vxeList: 'vhb-list',
        vxePulldown: 'vhb-pulldown'
      }
    },
    header: {
      label: {
    ...
    footer: {
      donation: '支持我们',
      donationDesc: 'vhb-table is open source and free for MIT. In order to make the project healthy and sustainable development, you can support the author through donation.'
    },
    api: {
