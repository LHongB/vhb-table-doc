<template>
  <div>
    ...
    <vhb-toolbar print>
      <template #buttons>
        <vhb-button @click="printEvent1">打印表格</vhb-button>
        <vhb-button @click="printSelectEvent1">打印勾选行</vhb-button>
      </template>
    </vhb-toolbar>
    ...
    <vhb-toolbar>
      <template #buttons>
        <vhb-button @click="printEvent5">打印下面的区域</vhb-button>
      </template>
    </vhb-toolbar>
    ...
    <vhb-toolbar>
      <template #buttons>
        <vhb-button @click="printEvent4">打印自定义模板</vhb-button>
      </template>
    </vhb-toolbar>
    ...
    <vhb-toolbar>
      <template #buttons>
        <vhb-button @click="printEvent6">打印图片</vhb-button>
      </template>
    </vhb-toolbar>
...
<div class="my-top">
  <div class="my-list-row">
    <div class="my-list-col">商品名称：vhb-table</div>
  ...
  data () {
    return {
      ...
      codeList: [
        ...
        { name: 'vhb-table pro test abc', price: 888, code: 1201775112606 },
