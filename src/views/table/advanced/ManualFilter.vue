<template>
  <div>
    ...
    <vhb-toolbar>
      <template #buttons>
        <vhb-button @click="filterNameEvent">筛选 Name</vhb-button>
        <vhb-button @click="filterAgeEvent">筛选 Age</vhb-button>
        <vhb-button @click="updateNameFilterEvent">更改 Name 的筛选条件</vhb-button>
        <vhb-button @click="$refs.xTable.clearFilter($refs.xTable.getColumnByField('age'))">清除 Age 的筛选条件</vhb-button>
        <vhb-button @click="$refs.xTable.clearFilter()">清除所有的筛选条件</vhb-button>
        <vhb-button @click="$refs.xTable.openFilter('age')">弹出筛选面板</vhb-button>
        <vhb-button @click="$refs.xTable.clearFilter()">关闭筛选面板</vhb-button>
      </template>
    </vhb-toolbar>
    ...
    <vhb-table
      ...
      <vhb-column
        ...
        :filter-method="filterNameMethod"></vhb-column>
      <vhb-column
        field="role"
        title="Role"
        sortable
      ...
      <vhb-column
        ...
        :filters="[{label: 'Man', value: '1'}, {label: 'Woman', value: '0'}]"></vhb-column>
      <vhb-column field="age" title="Age" :filters="[{ data: '' }]" :filter-method="filterAgeMethod" :filter-recover-method="filterAgeRecoverMethod">
        <template #filter="{ $panel, column }">
      ...
      <vhb-column field="amount" title="Amount" sortable></vhb-column>
    </vhb-table>
        ...
        export default {
          ...
          methods: {
            ...
            filterNameMethod ({ value, row, column }) {
              return HBUtils.toValueString(row.name).toLowerCase().indexOf(value) > -1
            },
