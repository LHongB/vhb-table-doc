<template>
  <div>
    ...
    <vhb-toolbar>
      <template #buttons>
        <vhb-button @click="allAlign = 'left'">居左</vhb-button>
        <vhb-button @click="allAlign = 'center'">居中</vhb-button>
        <vhb-button @click="allAlign = 'right'">居右</vhb-button>
      </template>
    </vhb-toolbar>
    ...
    <vhb-table
      ...
      :data="tableData3">
      <vhb-column type="seq" width="60"></vhb-column>
      <vhb-column field="key" title="Key"></vhb-column>
      <vhb-column field="content" title="Translate"></vhb-column>
      <vhb-column field="language" title="Language" :filters="[{label: '中文', value: 'zh_CN' }, {label: 'English', value: 'en_US'}]"></vhb-column>
    </vhb-table>
