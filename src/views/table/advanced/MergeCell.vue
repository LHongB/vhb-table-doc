<template>
  <div>
    ...
    <vhb-toolbar ref="xToolbar" print></vhb-toolbar>
    ...
    <vhb-table
      ...
      :data="tableData">
      <vhb-column field="a" title="名称"></vhb-column>
      <vhb-colgroup field="b" title="教育经费投入">
        <vhb-column field="c" title="总计"></vhb-column>
        <vhb-colgroup title="基本投入">
          <vhb-colgroup title="合计">
            <vhb-column field="d" title="合计"></vhb-column>
            <vhb-column field="e" title="比上年增长"></vhb-column>
          </vhb-colgroup>
          <vhb-column field="f" title="人员经费"></vhb-column>
          <vhb-column field="g" title="公用经费"></vhb-column>
          <vhb-colgroup title="其他经费">
            <vhb-column field="w" title="合计"></vhb-column>
            <vhb-colgroup title="其中">
              <vhb-column field="h" title="标准化建设"></vhb-column>
              <vhb-column field="i" title="信息化建设"></vhb-column>
            </vhb-colgroup>
          </vhb-colgroup>
        </vhb-colgroup>
        <vhb-column field="j" title="附加信息"></vhb-column>
      </vhb-colgroup>
      <vhb-colgroup title="其他投入">
        <vhb-colgroup title="投入">
          <vhb-column field="k" title="合计"></vhb-column>
          <vhb-colgroup title="其中">
            <vhb-column field="l" title="人员经费"></vhb-column>
            <vhb-column field="m" title="教育经费"></vhb-column>
            <vhb-column field="n" title="项目经费"></vhb-column>
            <vhb-column field="o" title="基建投入"></vhb-column>
          </vhb-colgroup>
        </vhb-colgroup>
        <vhb-colgroup title="社会捐款">
          <vhb-column field="p" title="合计"></vhb-column>
          <vhb-colgroup title="其中">
            <vhb-column field="q" title="项目经费"></vhb-column>
            <vhb-column field="r" title="基建投入"></vhb-column>
          </vhb-colgroup>
        </vhb-colgroup>
      </vhb-colgroup>
      <vhb-colgroup title="补充资料">
        <vhb-colgroup title="信息化建设">
          <vhb-column field="s" title="本年投入金额"></vhb-column>
          <vhb-colgroup title="其中">
            <vhb-column field="t" title="合计"></vhb-column>
            <vhb-column field="u" title="建设数"></vhb-column>
          </vhb-colgroup>
          <vhb-column field="v" title="备注"></vhb-column>
        </vhb-colgroup>
      </vhb-colgroup>
    </vhb-table>
