<template>
  <div>
    <p class="tip">使用自带的分页 <pager-api-link name="vhb-pager"/></p>
    ...
    <vhb-toolbar>
      <template #buttons>
        <vhb-button size="mini" @click="getSelectEvent">获取已选中的行数据</vhb-button>
        <vhb-button size="mini" @click="getSelectReserveEvent">获取已保留选中的行数据</vhb-button>
      </template>
    </vhb-toolbar>
        ...
        export default {
          ...
          methods: {
            ...
            getSelectReserveEvent () {
              ...
              VHBTable.modal.alert(selectReserveRecords.length)
            }
          }
        }
        `
