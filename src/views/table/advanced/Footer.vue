<template>
  <div>
    ...
    <vhb-table
      ...
      <vhb-column field="amount" title="Amount"></vhb-column>
    </vhb-table>
    ...
    <vhb-toolbar>
      <template #buttons>
        <vhb-button @click="showHeader = !showHeader">显示/隐藏表头</vhb-button>
        <vhb-button @click="showFooter = !showFooter">显示/隐藏表尾</vhb-button>
      </template>
    </vhb-toolbar>
    ...
    <vhb-table
      ...
      <vhb-colgroup title="基本信息">
        <vhb-column field="name" title="Name" min-width="600" sortable></vhb-column>
        <vhb-column field="age" title="Age" min-width="600"></vhb-column>
      </vhb-colgroup>
      <vhb-column field="date" title="Date" min-width="600"></vhb-column>
      <vhb-column field="amount" title="Amount" width="200" fixed="right"></vhb-column>
    </vhb-table>
    ...
    return {
      ...
      demoCodes: [
        ...
        <vhb-table
          ...
          <vhb-column field="date" title="Date" min-width="600"></vhb-column>
          <vhb-column field="rate" title="Rate" width="200" fixed="right"></vhb-column>
        </vhb-table>
        `,
        `
        export default {
