<template>
  <div>
    ...
    <vhb-toolbar>
      <template #buttons>
        <vhb-button @click="loadList(5000)">5k条</vhb-button>
        ...
        <vhb-button @click="loadList(300000)">30w条</vhb-button>
      </template>
    </vhb-toolbar>
    ...
    <vhb-table
      ...
      <vhb-column field="id" title="ID" width="200"></vhb-column>
      ...
      <vhb-column field="attr11" title="attr11" width="200"></vhb-column>
