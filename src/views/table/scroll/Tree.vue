  ...
  <div>
    ...
    <vhb-toolbar>
      <template #buttons>
        ...
        <vhb-button @click="$refs.xTable.setAllTreeExpand(false)">收起所有</vhb-button>
      </template>
    </vhb-toolbar>
    ...
    <vhb-table
      ...
      :scroll-y="{gt: 20}"
      :data="tableData">
      <vhb-column type="seq" width="200" tree-node></vhb-column>
...
export default {
  data () {
    return {
      tableData: [
        { id: 110000, parentId: null, name: 'vhb-table test abc1', type: 'mp3', size: 1024, date: '2020-08-01' },
        { id: 111000, parentId: 110000, name: 'vhb-table test abc2', type: 'html', size: 600, date: '2021-04-01' },
        { id: 111100, parentId: 111000, name: 'vhb-table test abc3', type: 'html', size: 600, date: '2021-04-01' },
        { id: 111110, parentId: 111100, name: 'vhb-table test abc4', type: 'html', size: 600, date: '2021-04-01' },
        { id: 111111, parentId: 111110, name: 'vhb-table test abc5', type: 'html', size: 600, date: '2021-04-01' },
        { id: 111112, parentId: 111110, name: 'vhb-table test abc6', type: 'html', size: 600, date: '2021-04-01' },
        ...
        { id: 121100, parentId: 121000, name: 'vhb-table test abc9', type: 'html', size: 600, date: '2021-04-01' },
        { id: 121200, parentId: 121000, name: 'vhb-table test abc10', type: 'avi', size: null, date: '2021-04-01' },
        { id: 121300, parentId: 121000, name: 'vhb-table test abc11', type: 'txt', size: 25, date: '2021-10-01' },
        ...
        { id: 163600, parentId: 164000, name: 'vhb-table test abc29', type: 'js', size: 1024, date: '2021-06-01' },
        ...
        { id: 164300, parentId: 164000, name: 'vhb-table test abc33', type: 'js', size: 1024, date: '2021-06-01' },
        ...
        { id: 164900, parentId: 164000, name: 'vhb-table test abc40', type: 'js', size: 1024, date: '2021-06-01' },
        ...
        { id: 230000, parentId: null, name: 'vhb-table test abc67', type: 'avi', size: 224, date: '2020-10-01' },
        ...
        { id: 254200, parentId: 254000, name: 'vhb-table test abc75', type: 'js', size: 1024, date: '2021-06-01' },
        ...
        { id: 254323, parentId: 254320, name: 'vhb-table test abc81', type: 'js', size: 1024, date: '2021-06-01' },
        ...
        { id: 254340, parentId: 254300, name: 'vhb-table test abc87', type: 'js', size: 1024, date: '2021-06-01' },
        ...
        { id: 254370, parentId: 254300, name: 'vhb-table test abc90', type: 'js', size: 1024, date: '2021-06-01' },
        ...
        { id: 254600, parentId: 254000, name: 'vhb-table test abc93', type: 'js', size: 1024, date: '2021-06-01' },
        ...
        { id: 262100, parentId: 262000, name: 'vhb-table test abc103', type: 'avi', size: 224, date: '2020-10-01' },
        ...
        { id: 264000, parentId: 260000, name: 'vhb-table test abc107', type: 'avi', size: 224, date: '2020-10-01' },
        ...
        { id: 290000, parentId: null, name: 'vhb-table test abc110', type: 'avi', size: 224, date: '2020-10-01' },
        ...
        { id: 325000, parentId: 320000, name: 'vhb-table test abc118', type: 'avi', size: 224, date: '2020-10-01' },
        ...
        { id: 329100, parentId: 329000, name: 'vhb-table test abc123', type: 'avi', size: 224, date: '2020-10-01' },
        ...
        { id: 329810, parentId: 329800, name: 'vhb-table test abc130', type: 'avi', size: 224, date: '2020-10-01' },
