<template>
  <div>
    ...
    <vhb-toolbar>
      <template #buttons>
        <vhb-button @click="$refs.xTree.toggleTreeExpand(tableData[1], true)">切换第一个</vhb-button>
        <vhb-button @click="$refs.xTree.setTreeExpand(tableData[8], true)">展开第三个</vhb-button>
