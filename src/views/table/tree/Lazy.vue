<template>
  <div>
    ...
    <vhb-toolbar>
      <template #buttons>
        <vhb-button @click="$refs.xTree.toggleTreeExpand(tableData1[1])">切换第二行展开</vhb-button>
        <vhb-button @click="$refs.xTree.setTreeExpand([tableData1[1], tableData1[3]], true)">设置第二、四行展开</vhb-button>
    ...
    <vhb-table
      ...
      <vhb-column field="name" title="Name" width="400" tree-node></vhb-column>
    ...
    <vhb-table
      ...
      :data="tableData2">
      <vhb-column type="checkbox" title="Name" width="400" tree-node></vhb-column>
      <vhb-column field="size" title="Size"></vhb-column>
      <vhb-column field="type" title="Type"></vhb-column>
      <vhb-column field="date" title="Date"></vhb-column>
    </vhb-table>
