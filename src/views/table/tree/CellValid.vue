<template>
  <div>
    ...
    <vhb-table
      ...
      :data="tableData">
      <vhb-column type="checkbox" title="ID" tree-node></vhb-column>
      ...
      <vhb-column field="size" title="Size" :edit-render="{}">
        <template #edit="scope">
          <vhb-input v-model="scope.row.size" type="text" @change="$refs.xTable.updateStatus(scope)"></vhb-input>
        </template>
      </vhb-column>
      <vhb-column field="type" title="Type" :edit-render="{}">
        <template #edit="scope">
          <vhb-input v-model="scope.row.type" type="text" @change="$refs.xTable.updateStatus(scope)"></vhb-input>
        </template>
      </vhb-column>
