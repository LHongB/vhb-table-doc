<template>
  <div>
    ...
    <vhb-table
      ...
      :data="tableData2">
      <vhb-column type="radio" title="Name" width="400" tree-node></vhb-column>
      <vhb-column field="size" title="Size"></vhb-column>
      <vhb-column field="type" title="Type"></vhb-column>
      <vhb-column field="date" title="Date"></vhb-column>
    </vhb-table>
    ...
    <vhb-table
      ...
      <vhb-column type="radio" width="400" tree-node>
        <template #header>
          <vhb-button type="text" @click="clearCurrentRowEvent" :disabled="!selectRow">取消</vhb-button>
        </template>
      </vhb-column>
      <vhb-column field="size" title="Size"></vhb-column>
      <vhb-column field="type" title="Type"></vhb-column>
