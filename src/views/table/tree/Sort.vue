<template>
  <div>
    ...
    <vhb-table
      ...
      <vhb-column field="id" title="ID" width="80"></vhb-column>
      <vhb-column field="name" title="名称" tree-node></vhb-column>
      <vhb-column field="size" title="大小" width="140"></vhb-column>
      <vhb-column field="type" title="类型" width="140"></vhb-column>
      <vhb-column field="date" title="修改日期" width="260" sortable></vhb-column>
    </vhb-table>
          ...
          methods: {
            ...
            findList (order) {
              ...
              setTimeout(() => {
                ...
                // 将有关联的列表转成树结构
                if (order === 'asc') {
                  this.tableData = HBUtils.toArrayTree(this.originData, { key: 'id', parentKey: 'parentId', sortKey: 'date', reverse: false })
                } else if (order === 'desc') {
                  this.tableData = HBUtils.toArrayTree(this.originData, { key: 'id', parentKey: 'parentId', sortKey: 'date', reverse: true })
                } else {
                  this.tableData = HBUtils.toArrayTree(this.originData, { key: 'id', parentKey: 'parentId' })
                }
              }, 300)
            },
