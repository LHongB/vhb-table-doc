<template>
  <div>
    ...
    <vhb-table
      ...
      :data="tableData">
      <vhb-column field="name" title="名称" tree-node :formatter="formatName"></vhb-column>
      <vhb-column field="level" title="级别"></vhb-column>
      <vhb-column field="age" title="年龄"></vhb-column>
      <vhb-column field="rate" title="分数"></vhb-column>
    </vhb-table>
        ...
        export default {
          ...
          methods: {
            ...
            getGroupSummary (data) {
              HBUtils.eachTree(data, (row, index, items, path, parent, nodes) => {
