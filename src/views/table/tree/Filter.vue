<template>
  <div>
    ...
    <vhb-table
      ...
      <vhb-column type="seq" width="140" tree-node></vhb-column>
      <vhb-column field="name" title="名称"></vhb-column>
      <vhb-column field="size" title="大小" width="140"></vhb-column>
      <vhb-column field="type" title="类型" width="140" :filters="[{label: 'js', value: 'js'}, {label: 'mp3', value: 'mp3'}, {label: 'avi', value: 'avi'}]"></vhb-column>
      <vhb-column field="date" title="修改日期" width="260"></vhb-column>
    </vhb-table>
