<template>
  <div>
    ...
    <vhb-table
      ...
      :tree-config="{transform: true, accordion: true, line: true, iconOpen: 'vhb-icon--caret-right rotate45', iconClose: 'vhb-icon--caret-right'}"
      :checkbox-config="{labelField: 'name'}"
      :data="tableData2"
      :scroll-y="{enabled: false}">
      <vhb-column type="checkbox" title="Name" width="280" tree-node></vhb-column>
      <vhb-column field="size" title="Size"></vhb-column>
      <vhb-column field="type" title="Type"></vhb-column>
      <vhb-column field="date" title="Date"></vhb-column>
    </vhb-table>
    ...
    <vhb-table
      ...
      :data="tableData3"
      :scroll-y="{enabled: false}">
      <vhb-column type="radio" title="Name" tree-node></vhb-column>
      <vhb-column field="size" title="Size"></vhb-column>
      <vhb-column field="type" title="Type"></vhb-column>
      <vhb-column field="date" title="Date"></vhb-column>
    </vhb-table>
    ...
    <vhb-table
      ...
      :data="tableData4"
      :scroll-y="{enabled: false}">
      <vhb-column type="checkbox" title="Name" tree-node>
    ...
    return {
      ...
      demoCodes: [
        ...
        <vhb-table
          ...
          :data="tableData4"
          :scroll-y="{enabled: false}">
          <vhb-column field="name" title="Name" tree-node>
            <template #default="{ row }">
              <span>
                <template v-if="row.children && row.children.length">
                  <i class="tree-node-icon fa" :class="$refs.xTree.isTreeExpandByRow(row) ? 'fa-folder-open-o' : 'fa-folder-o'"></i>
