  ...
  <div>
    ...
    <vhb-toolbar>
      <template #buttons>
        ...
        <vhb-button icon="fa fa-save" @click="getInsertEvent">获取新增</vhb-button>
      </template>
    </vhb-toolbar>
    ...
    <vhb-table
      ...
      <vhb-column field="nickname" title="Nickname" :edit-render="{autofocus: '.vhb-input--inner'}">
        <template #edit="{ row }">
          <vhb-input v-model="row.nickname" type="text"></vhb-input>
        </template>
      </vhb-column>
      <vhb-column field="address" title="Address" :edit-render="{autofocus: '.vhb-input--inner'}">
        <template #edit="{ row }">
