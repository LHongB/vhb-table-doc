<template>
  <div>
    ...
    <vhb-toolbar ref="xToolbar" export>
      <template #buttons>
        <vhb-button @click="insertEvent">新增</vhb-button>
        <vhb-button @click="removeEvent">删除</vhb-button>
    ...
    <vhb-table
      ...
      <vhb-colgroup title="统计信息">
        ...
        <vhb-column field="age" title="Age" :edit-render="{autofocus: '.vhb-input--inner'}">
          <template #edit="{ row }">
            <vhb-input v-model="row.age" type="text" :min="1" :max="120" @change="updateFooterEvent"></vhb-input>
          </template>
        </vhb-column>
        <vhb-column field="num1" title="Num" :edit-render="{autofocus: '.vhb-input--inner'}">
          <template #edit="{ row }">
            <vhb-input v-model="row.num1" type="text" @input="updateFooterEvent"></vhb-input>
          </template>
        </vhb-column>
        <vhb-column field="rate" title="Rate" :edit-render="{}">
          <template #edit="{ row }">
            <vhb-input v-model="row.rate" type="text" @input="updateFooterEvent"></vhb-input>
          </template>
        </vhb-column>
      </vhb-colgroup>
    </vhb-table>
...
<style>
.editable-footer .vhb-footer--column.col-blue {
  background-color: #2db7f5;
  color: #fff;
}
.editable-footer .vhb-footer--column.col-red {
