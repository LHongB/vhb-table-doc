    ...
    <vhb-table
      ...
      <vhb-column field="name" title="Name" :edit-render="{}">
        <template #edit="{ row, column }">
          <vhb-input v-model="row.name" type="text" @change="nameChangeEvent({ column })"></vhb-input>
        </template>
      </vhb-column>
      <vhb-column field="role" title="Role" :edit-render="{}">
        <template #edit="{ row, column }">
          <vhb-input v-model="row.role" type="text" @change="roleChangeEvent({ column })"></vhb-input>
        </template>
      </vhb-column>
      <vhb-column field="nickname" title="Nickname" :filters="[{ data: '' }]" :filter-render="{}" :edit-render="{}">
        ...
        <template #edit="{ row, column }">
          <vhb-input v-model="row.nickname" type="text" @focus="roleFocusEvent({ column })"></vhb-input>
        </template>
      </vhb-column>
      <vhb-column field="sex" title="Sex" :edit-render="{}">
        ...
        <template #edit="{ row, column }">
          <vhb-select v-model="row.sex" transfer @change="sexChangeEvent({ column })">
      ...
      <vhb-column field="date12" title="Date" :edit-render="{}">
        <template #edit="{ row, column }">
          <vhb-input v-model="row.date12" type="date" transfer @change="dateChangeEvent({ column })"></vhb-input>
        </template>
      </vhb-column>
    </vhb-table>
