  ...
  <div>
    ...
    <vhb-table
      ...
      <vhb-column field="role" title="Role" :edit-render="{}">
        <template #edit="{ row }">
          <vhb-input v-model="row.role" type="text" placeholder="请输入角色"></vhb-input>
        </template>
      </vhb-column>
      <vhb-column field="name" title="Name" :edit-render="{}">
        <template #edit="{ row }">
          <vhb-input v-model="row.name" type="text" placeholder="请输入名称"></vhb-input>
        </template>
      </vhb-column>
      <vhb-column field="address" title="Address" :edit-render="{}">
        <template #edit="{ row }">
          <vhb-input v-model="row.address" type="text" placeholder="请输入地址"></vhb-input>
        </template>
      </vhb-column>
    </vhb-table>
