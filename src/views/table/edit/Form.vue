<template>
  <div>
    ...
    <vhb-form :data="formData" @submit="findList">
      <vhb-form-item title="app.body.label.name" field="name" :item-render="{}">
      ...
      <vhb-form-item title="性别" field="sex" :item-render="{}">
        <template #default="{ data }">
          <vhb-select v-model="data.sex" placeholder="请选择性别">
            <vhb-option v-for="(item, index) in sexList" :key="index" :value="item.value" :label="item.label"></vhb-option>
          </vhb-select>
        </template>
      </vhb-form-item>
      <vhb-form-item>
    ...
    <vhb-table
      ...
      <vhb-column field="role" title="Role" :edit-render="{name: 'input', attrs: {type: 'text'}}">
        <template #edit="{ row }">
          <vhb-input v-model="row.role" type="text"></vhb-input>
        </template>
      </vhb-column>
      ...
      <vhb-column field="date13" title="Date" :edit-render="{}">
        <template #edit="{ row }">
          <vhb-input v-model="row.date13" type="date" placeholder="请选择日期" transfer></vhb-input>
        </template>
      </vhb-column>
    </vhb-table>
