    ...
    <vhb-table
      ...
      <vhb-colgroup title="分组1">
        ...
        <vhb-column field="sex" title="Sex" :edit-render="{}">
          ...
          <template #edit="{ row }">
            <vhb-select v-model="row.sex" :options="sexList" transfer></vhb-select>
          </template>
        </vhb-column>
      </vhb-colgroup>
      <vhb-colgroup title="分组2">
        <vhb-column field="num1" title="Number" :edit-render="{}">
          <template #edit="{ row }">
            <vhb-input v-model="row.num1" type="number" placeholder="请输入数值"></vhb-input>
          </template>
        </vhb-column>
        <vhb-column field="date12" title="Date" :edit-render="{}">
          <template #edit="{ row }">
