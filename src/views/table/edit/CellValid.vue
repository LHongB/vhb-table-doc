    ...
    <vhb-table
      ...
      <vhb-colgroup title="分组1">
        ...
        <vhb-column field="role" title="Role" :edit-render="{}">
          <template #edit="scope">
            <vhb-input v-model="scope.row.role" type="text" @change="$refs.xTable.updateStatus(scope)"></vhb-input>
          </template>
        </vhb-column>
      </vhb-colgroup>
      <vhb-colgroup title="分组2">
        <vhb-colgroup title="分组21">
          ...
          <vhb-column field="age" title="Age" :edit-render="{}">
            <template #edit="scope">
              <vhb-input v-model="scope.row.age" type="integer" @change="$refs.xTable.updateStatus(scope)"></vhb-input>
            </template>
          </vhb-column>
        ...
        export default {
          ...
          methods: {
            async validEvent () {
              ...
              if (errMap) {
                VHBTable.modal.message({ status: 'error', content: '校验不通过！' })
              } else {
                VHBTable.modal.message({ status: 'success', content: '校验成功！' })
              }
            },
            ...
            async selectValidEvent () {
              ...
              if (selectRecords.length > 0) {
                ...
                VHBTable.modal.message({ status: 'warning', content: '未选中数据！' })
              }
            },
            async insertEvent () {
              const $table = this.$refs.xTable
