<template>
  <div>
    <p class="tip">
      可编辑渲染 <table-column-api-link prop="edit-render"/>，查看 <a class="link" href="https://github.com/x-extends/vhb-table-docs/tree/main/v4/src/plugins/table/renderer" target="_blank">示例的源码</a><span class="red">（具体请自行实现，该示例仅供参考）</span><br>
      配置参数：<br>
    ...
    <vhb-table
      ...
      <vhb-column field="name" title="简单输入框" :edit-render="{name: 'MyInput'}"></vhb-column>
      <vhb-column field="role" title="下拉表格" :edit-render="{name: 'EditDownTable'}"></vhb-column>
      <vhb-column field="sex" title="弹窗表格" :edit-render="{name: 'EditPopupModal'}"></vhb-column>
      <vhb-column field="address" title="复杂渲染" :edit-render="{name: 'EditDownModal'}"></vhb-column>
    </vhb-table>
