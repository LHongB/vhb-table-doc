<template>
  <div>
    <p class="tip">
      内容渲染 <table-column-api-link prop="content-render"/>，查看 <a class="link" href="https://github.com/x-extends/vhb-table-docs/tree/main/v4/src/plugins/table/renderer" target="_blank">示例的源码</a><span class="red">（具体请自行实现，该示例仅供参考）</span><br>
      配置参数：<br>
    ...
    <vhb-table
      ...
      <vhb-column type="expand" width="80" :content-render="{name: 'MyExpand'}"></vhb-column>
  ...
  data () {
    return {
      ...
      demoCodes: [
        `
        // 创建一个简单的展开内容渲染
        VHBTable.renderer.add('MyExpand', {
