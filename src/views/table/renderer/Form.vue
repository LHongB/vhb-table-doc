<template>
  <div>
    <p class="tip">
      表单-项渲染 <grid-api-link prop="itemRender"/>，查看 <a class="link" href="https://github.com/x-extends/vhb-table-docs/tree/main/v4/src/plugins/table/renderer" target="_blank">示例的源码</a><span class="red">（具体请自行实现，该示例仅供参考）</span><br>
      配置参数：<br>
    ...
    <vhb-grid
      ...
      :columns="tableColumn">
      <template #btns>
        <vhb-button type="submit" content="查询"></vhb-button>
