<template>
  <div>
    ...
    <vhb-table
      ...
      <vhb-column field="name" title="名称" :title-help="{message: '自定义帮助提示信息'}"></vhb-column>
      <vhb-column field="role" title="角色" :title-help="{message: '自定义图标', icon: 'fa fa-bell'}"></vhb-column>
      <vhb-column field="date" title="Date"></vhb-column>
      <vhb-column field="rate" title="Rate">
        <template #header>
          <span>自定义标题</span>
        </template>
      </vhb-column>
      <vhb-column field="address" title="Address" width="160"></vhb-column>
      <vhb-column type="html" field="content" title="Content" width="200"></vhb-column>
    </vhb-table>
