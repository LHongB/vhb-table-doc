<template>
  <div>
    ...
    <vhb-table
      ...
      <vhb-column type="checkbox" title="ID" width="140"></vhb-column>
      <vhb-column field="name" title="Name" sortable></vhb-column>
      <vhb-column field="sex" title="Sex" :filters="sexList" :filter-multiple="false" :formatter="formatterSex"></vhb-column>
      <vhb-column
        field="age"
        title="Age"
        sortable
        :filters="[{label: '大于16岁', value: 16}, {label: '大于26岁', value: 26}, {label: '大于30岁', value: 30}]"
        :filter-method="filterAgeMethod"></vhb-column>
