<template>
  <div>
    ...
    <vhb-table
      ...
      <vhb-column field="role" title="Role" width="200"></vhb-column>
      <vhb-column field="address" title="Address" width="200"></vhb-column>
    </vhb-table>
