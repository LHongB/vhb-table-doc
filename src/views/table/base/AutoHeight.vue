  ...
  <div>
    ...
    <div style="overflow: hidden; height: 500px">
      ...
      <vhb-table
        ...
        <vhb-column field="date13" title="Date" width="300"></vhb-column>
        <vhb-column field="address" title="Address" width="200" fixed="right" show-overflow></vhb-column>
      </vhb-table>
    </div>
    ...
    <vhb-toolbar>
      <template #buttons>
        <vhb-button @click="tableWidth = '600px'">宽600px</vhb-button>
        <vhb-button @click="tableWidth = '700px'">宽700px</vhb-button>
        <vhb-button @click="tableWidth = '800px'">宽800px</vhb-button>
        <vhb-button @click="tableHeight = '300px'">高300px</vhb-button>
        <vhb-button @click="tableHeight = '500px'">高500px</vhb-button>
        <vhb-button @click="tableHeight = '800px'">高800px</vhb-button>
      </template>
    </vhb-toolbar>
