<template>
  <div>
    ...
    <vhb-table
      ...
      <vhb-column field="name" title="名称" show-overflow="ellipsis"></vhb-column>
      <vhb-column field="role" title="角色" show-overflow></vhb-column>
      <vhb-column field="date" title="标题溢出，显示为 tooltip xxxxxxxxxx" show-header-overflow show-overflow="title" show-footer-overflow></vhb-column>
      <vhb-column field="rate" title="Rate" show-header-overflow="title">
        <template #header>
          <span>标题显示原生 title ___________________________</span>
        </template>
      </vhb-column>
      <vhb-column field="address" title="不换行不换行不换行不换行不换行不换行不换行不换行不换行" width="160"></vhb-column>
    </vhb-table>
    ...
    <vhb-table
      ...
      <vhb-column type="seq" width="60"></vhb-column>
      <vhb-column field="name" title="名称"></vhb-column>
      <vhb-column field="role" title="标题溢出直接隐藏 xxxxxxxxxxxxxxxxxxxxxxxxxxx" show-header-overflow="ellipsis"></vhb-column>
      <vhb-column field="date" title="Date" show-header-overflow show-overflow show-footer-overflow></vhb-column>
      <vhb-colgroup title="基本信息">
        <vhb-colgroup field="rate" show-header-overflow="title">
          <template #header>
            <span>标题溢出显示原生 title xxxxxxxxxxxxxxxxxxxxxxxxxxx</span>
          </template>
        </vhb-colgroup>
        <vhb-colgroup title="详细信息">
          <vhb-column type="html" field="address" title="标题溢出显示tooltip内容内容内容内容内容内容" width="160" show-header-overflow show-overflow></vhb-column>
        </vhb-colgroup>
      </vhb-colgroup>
    </vhb-table>
