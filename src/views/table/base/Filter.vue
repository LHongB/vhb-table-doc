<template>
  <div>
    ...
    <vhb-table
      ...
      <vhb-column field="name" title="Name" sortable :filters="[]" :filter-method="filterNameMethod"></vhb-column>
      <vhb-column field="sex" title="Sex" sortable :filters="[{label: 'Man', value: '1'}, {label: 'Woman', value: '0'}]" :filter-multiple="false"></vhb-column>
      <vhb-column field="age" title="Age" :filters="[{ data: '' }]" :filter-method="filterAgeMethod">
      ...
      <vhb-column field="time" title="Time" sortable></vhb-column>
    </vhb-table>
    ...
    <vhb-table
      ...
      <vhb-colgroup title="基本信息">
        <vhb-column field="name" title="Name" sortable :filters="[{label: 'id大于10003', value: 10002}, {label: 'id大于10003', value: 10003, checked: true},{label: 'id大于10004', value: 10004},{label: 'id大于10005', value: 10005},{label: 'id大于10006', value: 10006},{label: 'id大于10007', value: 10007}]" :filter-method="filterNameMethod"></vhb-column>
        <vhb-column field="sex" title="Sex" sortable :filters="[{label: 'Man', value: '1'}, {label: 'Woman', value: '0'}]"></vhb-column>
      </vhb-colgroup>
      <vhb-colgroup title="其他">
        <vhb-colgroup title="详细信息">
          <vhb-colgroup field="age" title="Age" :filters="[{ data: '30' }]" :filter-method="filterAgeMethod">
            <template #filter="{ $panel, column }">
              <input type="type" v-for="(option, index) in column.filters" :key="index" v-model="option.data" @input="$panel.changeOption($event, !!option.data, option)">
            </template>
          </vhb-colgroup>
      ...
      <vhb-column field="time" title="Time" sortable :filters="[{label: '本周', value: '1'}, {label: '上周', value: '2'}]"></vhb-column>
    </vhb-table>
