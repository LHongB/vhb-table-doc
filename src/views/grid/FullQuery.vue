  ...
  <div>
    ...
    <vhb-grid ref="xGrid" v-bind="gridOptions">
      ...
      <template #toolbar_buttons>
        <vhb-form :data="formData" @submit="searchEvent" @reset="resetEvent">
          <vhb-form-item field="name">
            <template>
              <vhb-input v-model="formData.name" type="text" placeholder="请输入名称"></vhb-input>
            </template>
          </vhb-form-item>
          <vhb-form-item>
            <template>
              <vhb-button type="submit" status="primary" content="查询"></vhb-button>
              <vhb-button type="reset" content="重置"></vhb-button>
            </template>
          </vhb-form-item>
        </vhb-form>
      </template>
        ...
        proxyConfig: {
          ...
          ajax: {
            ...
            query: ({ page, sorts, filters }) => {
              ...
              return fetch(`${this.serveApiUrl}/api/pub/page/list/${page.pageSize}/${page.currentPage}?${HBUtils.serialize(queryParams)}`).then(response => response.json())
            },
