<template>
  <div>
    <p class="tip">
      数据代理<a class="link" href="https://github.com/x-extends/vhb-table-demo/tree/master/vhb-table-by-grid">（项目示例）</a>：通过配置 <grid-api-link prop="proxy-config"/> 参数，默认直接读取结果，响应结果应该为数组；
    ...
    <vhb-grid v-bind="gridOptions"></vhb-grid>
