  ...
  <div>
    ...
    <vhb-grid v-bind="gridOptions">
      ...
      <template #size_edit="{ row }">
        <vhb-input v-model="row.size"></vhb-input>
      </template>
      <template #createtime_edit="{ row }">
        <vhb-input v-model="row.createTime" type="date" labelFormat="yyyy-MM-dd HH:mm:ss" transfer></vhb-input>
      </template>
      <template #updatetime_edit="{ row }">
        <vhb-input v-model="row.updateTime" type="date" labelFormat="yyyy-MM-dd HH:mm:ss" transfer></vhb-input>
      </template>
    </vhb-grid>
