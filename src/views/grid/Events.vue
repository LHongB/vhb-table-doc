<template>
  <div>
    ...
    <vhb-grid v-bind="gridOptions">
      <template #name_edit="{ row, column }">
        <vhb-input v-model="row.name" @change="nameChangeEvent({ column })"></vhb-input>
      </template>
      <template #role_edit="{ row, column }">
        <vhb-input v-model="row.role" @change="roleChangeEvent({ column })"></vhb-input>
      </template>
      <template #age_edit="{ row, column }">
        <vhb-input v-model="row.age" @focus="ageFocusEvent({ column })"></vhb-input>
      </template>
      ...
      <template #sex_edit="{ row, column }">
        <vhb-select v-model="row.sex" transfer @change="sexChangeEvent({ column })">
          <vhb-option value="1" label="男"></vhb-option>
          <vhb-option value="0" label="女"></vhb-option>
        </vhb-select>
      </template>
      <template #date_edit="{ row, column }">
        <vhb-input v-model="row.date" type="date" transfer @change="dateChangeEvent({ column })"></vhb-input>
      </template>
    </vhb-grid>
