<template>
  <div>
    <p class="tip">
      <grid-api-link name="vhb-grid"/> 高级表格：一个包含表单、工具栏、基础表格、分页...等全功能的组件<br>
    </p>

    <vhb-grid v-bind="gridOptions1">
      <template #toolbar_buttons>
        <vhb-button @click="gridOptions1.align = 'left'">居左</vhb-button>
        <vhb-button @click="gridOptions1.align = 'center'">居中</vhb-button>
        <vhb-button @click="gridOptions1.align = 'right'">居右</vhb-button>
      </template>
    </vhb-grid>
    ...
    <vhb-grid v-bind="gridOptions2"></vhb-grid>
