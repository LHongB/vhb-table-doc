<template>
  <div>
    ...
    <vhb-grid class="reverse-table" v-bind="gridOptions1"></vhb-grid>
    ...
    <vhb-grid class="reverse-table" v-bind="gridOptions2"></vhb-grid>
  ...
  data () {
    return {
      ...
      demoCodes: [
        ...
        `,
        `
        .reverse-table .vhb-body--row .vhb-body--column:first-child {
