  ...
  <div>
    ...
    <vhb-grid
      ...
      <template #toolbar_buttons>
        <vhb-button @click="$refs.xGrid.maximize()">表格最大化</vhb-button>
        <vhb-button @click="$refs.xGrid.revert()">表格还原</vhb-button>
        <vhb-button @click="$refs.xGrid.zoom()">切换表格最大化/还原</vhb-button>
      </template>
    </vhb-grid>
