<template>
  <div>
    ...
    <vhb-grid v-bind="gridOptions1" @edit-disabled="editDisabledEvent">
      <template #name_edit="{ row }">
        <vhb-input v-model="row.name"></vhb-input>
      </template>
      <template #sex_edit="{ row }">
        <vhb-input v-model="row.sex"></vhb-input>
      </template>
      <template #age_edit="{ row }">
        <vhb-input v-model="row.age"></vhb-input>
      </template>
    ...
    <vhb-grid ref="xGrid2" v-bind="gridOptions2" @edit-actived="editActivedEvent">
      <template #name_edit="{ row }">
        <vhb-input v-model="row.name" :disabled="disabledName"></vhb-input>
      </template>
      <template #sex_edit="{ row }">
        <vhb-input v-model="row.sex" :disabled="disabledSex"></vhb-input>
      </template>
      <template #age_edit="{ row }">
        <vhb-input v-model="row.age" :disabled="disabledAge"></vhb-input>
      </template>
      <template #address_edit="{ row }">
        <vhb-input v-model="row.address"></vhb-input>
      </template>
