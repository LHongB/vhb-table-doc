...
const apis = [
  {
    ...
    list: [
      ...
      },
      {
        ...
        list: HBUtils.clone(exportDataAPI, true)
      },
      {
        name: 'import-config',
        ...
        list: HBUtils.clone(importDataAPI, true)
      },
      {
        name: 'print-config',
        ...
        list: HBUtils.clone(printAPI, true)
      },
      {
        name: 'radio-config',
      ...
      },
      {
        ...
        list: [
          ...
          },
          {
            ...
            enum: '',
            defVal: '',
            list: HBUtils.clone(contextMenuAPI, true)
          },
          {
            name: 'body',
            desc: '内容的右键菜单',
  ...
  },
  {
    ...
    list: [
      ...
      },
      {
        ...
        enum: '',
        defVal: 'options: object',
        list: HBUtils.clone(exportDataAPI.filter(item => !['data', 'download', 'columnFilterMethod', 'dataFilterMethod', 'footerFilterMethod'].includes(item.name)), true)
      },
      {
