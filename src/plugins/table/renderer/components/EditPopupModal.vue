<template>
  <div class="edit-popup-modal">
    <vhb-input class="edit-popup-input" v-model="row[column.property]" placeholder="请选择"></vhb-input>
    <vhb-button class="edit-popup-button" icon="fa fa-list" type="text" @click="popupEvent"></vhb-button>
    <vhb-modal
      show-footer
